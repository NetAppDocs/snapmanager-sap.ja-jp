...
+
`* SMSAPリポジトリロールアップupgrade -repository -dbdbname_repo_service_name -host_repo_username -login-username repo_repo_repo_username _-port_repo_port_-upgradehost_with _target_database-force [-quiet |-verbose *`

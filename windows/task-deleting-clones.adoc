...
. 次のコマンドを入力します。SMSAP clone delete -profile profile_name [-labellabel |-idguid][-force-][-dump][-quiet ]|[-verbose]
...
xref:reference-the-smosmsapclone-delete-command.adoc[SMSAPのclone deleteコマンドを使用します]

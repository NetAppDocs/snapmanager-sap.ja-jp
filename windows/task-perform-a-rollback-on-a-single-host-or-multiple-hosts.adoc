...
+
'*smsaprepository rollback -repository-dbname_repo_repo_service_name_-login-username repo_repo_repo_repo_username -port_repo_repo_port_-rollbackhost_with _target_database1、_host_with _target_database2_*
